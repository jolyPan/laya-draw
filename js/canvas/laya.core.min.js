...
var Laya = window.Laya = function(t, e) {
  var i = {
      ...
      interface: function(e, n) {
          ...
          for (var l = t, u = e.split("."), a = 0; a < u.length - 1; a++)
              l = l[u[a]];
          l[u[u.length - 1]] = {
              __interface__: e
          }
      ...
      class: function(e, n, s, r) {
          ...
          var a = i.un
            , h = e.prototype;
          a(h, "hasOwnProperty", i.__hasOwnProperty),
          a(h, "__class", e),
          a(h, "__super", s),
          a(h, "__className", n),
          a(e, "__super", s),
      ...
      getset: function(t, e, n, s, r) {
          t ? (s && (e["_$GET_" + n] = s),
          r && (e["_$SET_" + n] = r)) : (s && i.un(e, "_$get_" + n, s),
          r && i.un(e, "_$set_" + n, r)),
...
function(t, e, i) {
  ...
  var o = function() {
      function e() {}
      return s(e, "laya.utils.RunDriver"),
      e.FILTER_ACTIONS = [],
      e.pixelRatio = -1,
      ...
      e.getPixelRatio = function() {
          if (e.pixelRatio < 0) {
              ...
              e.pixelRatio = (N.window.devicePixelRatio || 1) / i,
              e.pixelRatio < 1 && (e.pixelRatio = 1)
          }
          return e.pixelRatio
      }
      ,
      ...
      e.drawToCanvas = function(t, e, i, n, s, r) {
          var o = yt.create("2D")
            , a = new D(i,n,o);
          return F.renders[e]._fun(t, a, s, r),
          o
      }
      ,
    ...
    , a = (function() {
      ...
      i.init = function(t, e, n) {
          for (var s = [], r = 2, o = arguments.length; r < o; r++)
              s.push(arguments[r]);
          if (!i._isinit) {
              ...
              for (var r = 0, a = s.length; r < a; r++)
                  s[r].enable && s[r].enable();
              return _.__init__(),
              c.__init__(),
              O.__init__(),
              W.beginCheck(),
              i._currentStage = i.stage = new mt,
              ...
              F.__init__(),
              m.__init__(),
              v.instance.__init__(i.stage, R.canvas),
              xt.__init__(),
              E.autoStopMusic = !0,
              I.__init__(),
              R.canvas
      ...
      i.getUrlPath = function() {
          ...
          L.rootPath = L.basePath = L.getPath("file:" == t.protocol ? e : t.protocol + "//" + t.host + t.pathname)
      }
      ,
  ...
  function() {
    ...
    , h = function() {
      ...
      i._createListener = function(t, i, n, s, r, o) {
          ...
          var h = this._events;
          return h[t] ? h[t].run ? h[t] = [h[t], a] : h[t].push(a) : h[t] = a,
          this
      }
      ,
      i.off = function(t, e, i, n) {
          ...
          if (null != i)
              if (s.run)
                  e && s.caller !== e || s.method !== i || n && !s.once || (delete this._events[t],
                  s.recover());
              else {
                  for (var r = 0, o = 0, a = s.length; o < a; o++) {
                      var h = s[o];
                      !h || e && h.caller !== e || h.method !== i || n && !h.once || (r++,
                      s[o] = null,
                      h.recover())
                  }
    ...
    , u = function() {
      ...
      e.parseFont = function(t, e) {
          if (null != t && null != e) {
              ...
              var n = i[0].getAttributeNode("padding").nodeValue
                , s = n.split(",");
              ...
              for (o = 0; o < r.length; o++) {
                  var a = r[o]
                    , h = parseInt(a.getAttributeNode("id").nodeValue)
                    , l = parseInt(a.getAttributeNode("xoffset").nodeValue) / 1
                    , u = parseInt(a.getAttributeNode("yoffset").nodeValue) / 1
                    , c = parseInt(a.getAttributeNode("xadvance").nodeValue) / 1
                    , _ = new P;
                  _.x = parseInt(a.getAttributeNode("x").nodeValue),
                  ...
                  var d = lt.create(e, _.x, _.y, _.width, _.height, l, u);
                  this._maxWidth = Math.max(this._maxWidth, c + this.letterSpacing),
                  this._fontCharDic[h] = d,
      ...
      e.parseFont2 = function(t, e) {
          if (null != t && null != e) {
              ...
              var r = t.getElementsByTagName("char")
                , o = 0;
              for (o = 0; o < r.length; o++) {
                  var a = r[o].attributes
                    , h = parseInt(a.id.nodeValue)
                    , l = parseInt(a.xoffset.nodeValue) / 1
                    , u = parseInt(a.yoffset.nodeValue) / 1
                    , c = parseInt(a.xadvance.nodeValue) / 1
                    , _ = new P;
                  _.x = parseInt(a.x.nodeValue),
      ...
      e.drawText = function(t, e, i, n, s, r) {
          ...
          for (var l = 0, u = 0, c = t.length; u < c; u++)
              (o = this.getCharTexture(t.charAt(u))) && (e.graphics.drawTexture(o, i + l + h, n),
    ...
    , _ = function() {
      function t(e) {
          ...
          this._text = null,
          this.indent = 0,
          this._color = U.create(t.defaultColor),
      ...
      return e.set = function(t) {
          ...
          for (var e = t.split(" "), i = 0, n = e.length; i < n; i++) {
              ...
              s.indexOf("px") > 0 && (this.size = parseInt(s),
              this.family = e[i + 1],
              i++)
          }
      }
      ...
      r(0, e, "decoration", function() {
          ...
          e[1] && (this._decoration.color = U.create(e)),
    ...
    , d = function() {
      ...
      return s(t, "laya.display.css.TransformInfo"),
      t
  }()
    , f = function() {
      function e() {
          ...
          R.isConchNode) {
              var e = this;
              e._nativeObj = new t._conchGraphics,
      ...
      n.clear = function(t) {
          ...
          if (t) {
              ...
              if (this._cmds) {
                  ...
                  i = 0; i < n; i++)
                      !(s = this._cmds[i]) || s.callee !== R._context._drawTexture && s.callee !== R._context._drawTextureWithTransform || (s[0] = null,
                      e._cache.push(s));
                  this._cmds.length = 0
              } else
                  s && (!s || s.callee !== R._context._drawTexture && s.callee !== R._context._drawTextureWithTransform || (s[0] = null,
                  e._cache.push(s)))
          } else
              this._cmds = null;
          if (this._one = null,
          ...
          this._vectorgraphArray) {
              ...
              n = this._vectorgraphArray.length; i < n; i++)
                  q.getInstance().deleteShape(this._vectorgraphArray[i]);
      ...
      n.drawTexture = function(t, i, n, s, r, o, a) {
          ...
          r || (r = t.sourceHeight),
          a = a < 0 ? 0 : a > 1 ? 1 : a;
          var h = !R.isWebGL && (N.onFirefox || N.onEdge || N.onIE || N.onSafari) ? .5 : 0
            , l = s / t.sourceWidth
            , u = r / t.sourceHeight;
          if (s = t.width * l,
          r = t.height * u,
          ...
          s += 2 * h,
          r += 2 * h,
          e._cache.length ? (c = e._cache.pop(),
          c[0] = t,
          c[1] = i,
          c[2] = n,
          c[3] = s,
          c[4] = r,
          c[5] = o,
          c[6] = a) : c = [t, i, n, s, r, o, a],
          c.callee = o || 1 != a ? R._context._drawTextureWithTransform : R._context._drawTexture,
          null != this._one || o || 1 != a ? this._saveToCmd(c.callee, c) : (this._one = c,
      ...
      n.fillTexture = function(t, e, i, n, s, r, o) {
          ...
          t) {
              ...
              t.loaded || t.once("loaded", this, this._textureLoaded, [t, a]),
              this._saveToCmd(R._context._fillTexture, a)
          }
      }
      ,
      ...
      n.drawTriangles = function(t, e, i, n, s, r, o, a, h, l) {
          void 0 === a && (a = 1),
          this._saveToCmd(R._context.drawTriangles, [t, e, i, n, s, r, o, a, h, l])
      }
      ,
      ...
      n.fillText = function(t, e, i, n, s, r, o) {
          void 0 === o && (o = 0),
          this._saveToCmd(R._context._fillText, [t, e, i, n || _.defaultFont, s, r])
      }
      ,
      ...
      n.loadImage = function(t, e, n, s, r, o) {
          function a(t) {
              t && (h.drawTexture(t, e, n, s, r),
              null != o && o.call(h._sp, t))
          }
          var h = this;
          void 0 === e && (e = 0),
          void 0 === n && (n = 0),
      ...
      n._renderAll = function(t, e, i, n) {
          for (var s, r = this._cmds, o = 0, a = r.length; o < a; o++)
              (s = r[o]).callee.call(e, i, n, s)
      }
      ,
      ...
      n.drawCircle = function(t, e, i, n, s, r) {
          ...
          var o = s ? r / 2 : 0
            , a = 0;
          R.isWebGL && (a = q.getInstance().getId(),
          null == this._vectorgraphArray && (this._vectorgraphArray = []),
      ...
      e.__init__ = function() {
          if (R.isConchNode) {
              ...
              t.drawTexture = function(t, e, i, n, s, r, o) {
                  ...
                  t) {
                      if (!t.loaded)
                          return void t.once("loaded", this, function() {
              ...
              t.fillTexture = function(t, e, i, n, s, r, o) {
                  ...
                  void 0 === r && (r = "repeat"),
                  t && t.loaded) {
                      var a, h = R._context.ctx, l = t.bitmap.width, u = t.bitmap.height, c = t.uv;
                      a = t.uv != lt.DEF_UV ? h.createPattern(t.bitmap.source, r, c[0] * l, c[1] * u, (c[2] - c[0]) * l, (c[5] - c[3]) * u) : h.createPattern(t.bitmap.source, r);
                      var _ = 0
                        , d = 0;
                      o && (e += o.x % t.width,
                      i += o.y % t.height,
    ...
    , p = function() {
      ...
      e.getBounds = function(t) {
          return void 0 === t && (t = !1),
          (!this._bounds || !this._temp || this._temp.length < 1 || t != this._cacheBoundsType) && (this._bounds = P._getWrapRec(this.getBoundPoints(t), this._bounds)),
      ...
      e.getBoundPoints = function(t) {
          ...
          this._cacheBoundsType = t,
          this._rstBoundPoints = K.copyArray(this._rstBoundPoints, this._temp)
      }
      ,
      e._getCmdPoints = function(e) {
          ...
          i.length = 0,
          s || null == this._graphics._one || (t._tempCmds.length = 0,
          ...
          var o = t._initMatrix;
          o.identity();
          for (var a, h, l = t._tempMatrix, u = NaN, c = NaN, _ = NaN, d = NaN, f = NaN, p = NaN, g = 0, m = s.length; g < m; g++)
              if (a = s[g],
              a.callee)
                  switch (a.callee) {
                  case n._save:
                  ...
                  case 17:
                      o.copyTo(l),
                      l.concat(a[4]),
                      t._addPointArrToRst(i, P._getBoundPointS(a[0], a[1], a[2], a[3]), l);
                      break;
                  case n._drawTexture:
                      h = a[0],
                      e ? a[3] && a[4] ? t._addPointArrToRst(i, P._getBoundPointS(a[1], a[2], a[3], a[4]), o) : (h = a[0],
                      t._addPointArrToRst(i, P._getBoundPointS(a[1], a[2], h.width, h.height), o)) : (u = (a[3] || h.sourceWidth) / h.width,
                      c = (a[4] || h.sourceHeight) / h.height,
                      _ = u * h.sourceWidth,
                      d = c * h.sourceHeight,
                      ...
                      f *= u,
                      p *= c,
                      t._addPointArrToRst(i, P._getBoundPointS(a[1] - f, a[2] - p, _, d), o));
                      break;
                  case n._fillTexture:
                      a[3] && a[4] ? t._addPointArrToRst(i, P._getBoundPointS(a[1], a[2], a[3], a[4]), o) : (h = a[0],
                      t._addPointArrToRst(i, P._getBoundPointS(a[1], a[2], h.width, h.height), o));
                      break;
                  case n._drawTextureWithTransform:
                      ...
                      l.concat(a[5]),
                      v = l) : v = o,
                      e ? a[3] && a[4] ? t._addPointArrToRst(i, P._getBoundPointS(a[1], a[2], a[3], a[4]), v) : (h = a[0],
                      t._addPointArrToRst(i, P._getBoundPointS(a[1], a[2], h.width, h.height), v)) : (h = a[0],
                      u = (a[3] || h.sourceWidth) / h.width,
                      c = (a[4] || h.sourceHeight) / h.height,
                      _ = u * h.sourceWidth,
                      d = c * h.sourceHeight,
                      f = h.offsetX > 0 ? h.offsetX : 0,
                      ...
                      f *= u,
                      p *= c,
                      t._addPointArrToRst(i, P._getBoundPointS(a[1] - f, a[2] - p, _, d), v));
                      break;
                  case n._drawRect:
                  case 13:
                      t._addPointArrToRst(i, P._getBoundPointS(a[0], a[1], a[2], a[3]), o);
                  ...
                  case 20:
                      ...
                      var y = NaN;
                      y = .5 * a[5],
                      a[0] == a[2] ? t._tempPoints.push(a[0] + y, a[1], a[2] + y, a[3], a[0] - y, a[1], a[2] - y, a[3]) : a[1] == a[3] ? t._tempPoints.push(a[0], a[1] + y, a[2], a[3] + y, a[0], a[1] - y, a[2], a[3] - y) : t._tempPoints.push(a[0], a[1], a[2], a[3]),
          ...
          return i.length > 200 ? i = K.copyArray(i, P._getWrapRec(i)._getBoundPoints()) : i.length > 8 && (i = b.scanPList(i)),
          i
      }
      ,
      ...
      e._getPiePoints = function(e, i, n, s, r) {
          ...
          var a = (r - s) % (2 * Math.PI)
            ...
            , u = s;
          for (l = 0; l <= 10; l++)
              o.push(e + n * Math.cos(u), i + n * Math.sin(u)),
              u += h;
          return o
      }
      ,
      ...
      t._addPointArrToRst = function(e, i, n, s, r) {
          ...
          for (a = i.length,
          o = 0; o < a; o += 2)
              t._addPointToRst(e, i[o] + s, i[o + 1] + r, n)
      }
      ,
      ...
      r(0, e, "touches", function() {
          ...
          if (t)
              for (var e = i.stage, n = 0, s = t.length; n < s; n++) {
                  var r = t[n]
                    , o = S.TEMP;
                  o.setTo(r.clientX, r.clientY),
                  e._canvasTransform.invertTransformPoint(o),
                  e.transform.invertTransformPoint(o),
                  r.stageX = o.x,
                  r.stageY = o.y
              }
          return t
  ...
  function() {
      function t() {}
      return s(t, "laya.events.KeyBoardManager"),
      t.__init__ = function() {
          t._addEvent("keydown"),
      ...
      t._dispatch = function(e, n) {
          if (t.enabled) {
              ...
              for (var s = i.stage.focus && null != i.stage.focus.event && i.stage.focus.displayedInStage ? i.stage.focus : i.stage, r = s; r; )
                  r.event(n, t._event.setTo(n, r, s)),
                  r = r.parent
          }
      }
      ,
  ...
  function() {
      ...
      return e.__init__ = function(e, i) {
          ...
          i.addEventListener("mousedown", function(e) {
              t.enabled && (N.onIE || e.preventDefault(),
              r.push(e),
          ...
          i.addEventListener("touchend", function(e) {
              ...
              t._isFirstTouch = !1,
              r.push(e),
              s.mouseDownTime = -N.now()) : n._curTouchID = NaN
          }, !0),
      ...
      e.check = function(t, e, i, n) {
          ...
          i = this._point.y;
          var s = t.scrollRect;
          if (s && (this._rect.setTo(s.x, s.y, s.width, s.height),
          ...
          if (!this.disableMouseEvent) {
              ...
              for (var r = t._childs.length - 1; r > -1; r--) {
                  var o = t._childs[r];
                  if (!o.destroyed && o.mouseEnabled && o.visible && this.check(o, e, i, n))
                      return !0
              }
          }
      ...
      e.runEvent = function() {
          ...
          if (e) {
              for (var i, n = this, s = 0, r = 0, o = 0; s < e; ) {
                  var a = this._eventList[s];
                  switch ("mousemove" !== a.type && (this._prePoint.x = this._prePoint.y = -1e6),
                  a.type) {
                  case "mousedown":
                      this._touchIDs[0] = this._id++,
                      t._isTouchRespond ? t._isTouchRespond = !1 : (n._isLeftMouse = 0 === a.button,
                      n.initEvent(a),
                      n.check(n._stage, n.mouseX, n.mouseY, n.onMouseDown));
                      break;
                  case "mouseup":
                      n._isLeftMouse = 0 === a.button,
                      n.initEvent(a),
                      n.check(n._stage, n.mouseX, n.mouseY, n.onMouseUp);
                      break;
                  case "mousemove":
                      ...
                      n.initEvent(a),
                      n.check(n._stage, n.mouseX, n.mouseY, n.onMouseMove));
                      break;
                  case "touchstart":
                      t._isTouchRespond = !0,
                      n._isLeftMouse = !0;
                  ...
                  case "touchcancel":
                      ...
                      o = l.length; r < o; r++)
                          ...
                          t.multiTouchEnabled || i.identifier == this._curTouchID) {
                              ...
                              n.initEvent(i, a);
                              var u = !1;
                              u = n.check(n._stage, n.mouseX, n.mouseY, n.onMouseUp),
                              u || n.onMouseUp(null)
                          }
                      break;
                  case "touchmove":
                      ...
                      o = c.length; r < o; r++)
                          i = c[r],
                          (t.multiTouchEnabled || i.identifier == this._curTouchID) && (n.initEvent(i, a),
                          n.check(n._stage, n.mouseX, n.mouseY, n.onMouseMove));
                      break;
                  case "wheel":
                  case "mousewheel":
    ...
    , y = function() {
      ...
      e.onMouseDown = function(e, i, n) {
          ...
          this.enable) {
              ...
              o = this.getEles(e, null, t._tEleArr),
              s ? s.tar = e : (r = this.createTouchO(e, i),
              this.preOvers.push(r)),
              N.onMobile && this.sendEvents(o, "mouseover", i);
              var a;
              a = n ? this.preDowns : this.preRightDowns,
              s = this.getTouchFromArr(i, a),
              s ? s.tar = e : (r = this.createTouchO(e, i),
              a.push(r)),
              this.sendEvents(o, n ? "mousedown" : "rightmousedown", i),
              this._clearTempArrs()
          }
      }
      ,
      e.sendEvents = function(t, e, i) {
          ...
          for (n = 0; n < s; n++) {
              ...
              o.destroyed)
                  return;
              if (o.event(e, this._event.setTo(e, o, r)),
              this._event._stoped)
                  break
          }
      }
      ...
      e.onMouseMove = function(e, i) {
          if (this.enable) {
              ...
              var s;
              n ? (this.checkMouseOutAndOverOfMove(e, n.tar),
              n.tar = e,
              s = this.getEles(e, null, t._tEleArr)) : (s = this.getEles(e, null, t._tEleArr),
          ...
          this.enable) {
              ...
              s = this.getTouchFromArr(i, _)) {
                  ...
                  e == s.tar)
                      ...
                      for (o = this.getEles(s.tar, null, t._oldArr),
                      h = t._newArr,
                      h.length = 0,
                      u = o.length,
                      l = 0; l < u; l++)
                          a = o[l],
                          r.indexOf(a) >= 0 && h.push(a);
                  h.length > 0 && this.sendEvents(h, n ? "click" : "rightclick", i),
                  n && d && this.sendEvents(h, "doubleclick", i),
                  this.removeTouchFromArr(i, _),
                  s.tar = null,
                  X.recover("TouchData", s)
              } else
                  ;s = this.getTouchFromArr(i, this.preOvers),
              s && c && (h = this.getEles(s.tar, null, h),
              h && h.length > 0 && this.sendEvents(h, "mouseout", i),
    ...
    , x = function() {
      ...
      e.apply = function(t) {
          ...
          if (0 == i.width || 0 == i.height)
              return i;
          for (var n, s = e.getImageData(0, 0, i.width, i.height), r = s.data, o = 0, a = r.length; o < a; o += 4)
              n = this.getColor(r[o], r[o + 1], r[o + 2], r[o + 3]),
              0 != r[o + 3] && (r[o] = n[0],
              r[o + 1] = n[1],
              r[o + 2] = n[2],
              r[o + 3] = n[3]);
      ...
      e.getColor = function(t, e, i, n) {
          ...
          if (this.data._mat && this.data._alpha) {
              var r = this.data._mat
                , o = this.data._alpha;
              s[0] = r[0] * t + r[1] * e + r[2] * i + r[3] * n + o[0],
              s[1] = r[4] * t + r[5] * e + r[6] * i + r[7] * n + o[1],
              s[2] = r[8] * t + r[9] * e + r[10] * i + r[11] * n + o[2],
              s[3] = r[12] * t + r[13] * e + r[14] * i + r[15] * n + o[3]
          }
          return s
      }
      ,
  ...
  function() {
      function t() {
          this._controlPoints = [new S, new S, new S],
      ...
      e.getBezierPoints = function(t, e, i) {
          ...
          for (; this._controlPoints.length <= i; )
              this._controlPoints.push(new S);
          for (n = 0; n < 2 * i; n += 2)
    ...
    , b = function() {
      function t() {}
      return s(t, "laya.maths.GrahamScan"),
      ...
      t.scan = function(e) {
          ...
          r = h - 1; r >= 0; r--)
              i = e[r],
              s = i.x + "_" + i.y,
              l.hasOwnProperty(s) || (l[s] = !0,
              n.push(i));
          for (h = n.length,
          K.copyArray(e, n),
          r = 1; r < h; r++)
              (e[r].y < e[a].y || e[r].y == e[a].y && e[r].x < e[a].x) && (a = r);
          for (i = e[0],
          e[0] = e[a],
          e[a] = i,
          r = 1; r < h - 1; r++) {
              for (a = r,
              o = r + 1; o < h; o++)
                  (t.multiply(e[o], e[a], e[0]) > 0 || 0 == t.multiply(e[o], e[a], e[0]) && t.dis(e[0], e[o]) < t.dis(e[0], e[a])) && (a = o);
              i = e[r],
              e[r] = e[a],
              e[a] = i
          }
    ...
    , C = function() {
      function t() {}
      return s(t, "laya.maths.MathUtil"),
      ...
      t.slerpQuaternionArray = function(t, e, i, n, s, r, o) {
          ...
          return h = _ * g + d * m + f * v + p * y,
          h < 0 && (h = -h,
          g = -g,
          m = -m,
          v = -v,
          y = -y),
          1 - h > 1e-6 ? (a = Math.acos(h),
          l = Math.sin(a),
          u = Math.sin((1 - s) * a) / l,
          c = Math.sin(s * a) / l) : (u = 1 - s,
          c = s),
          r[o + 0] = u * _ + c * g,
          r[o + 1] = u * d + c * m,
          r[o + 2] = u * f + c * v,
    ...
    , M = function() {
      ...
      e.rotateEx = function(t) {
          var e = Math.cos(t)
            ...
            , r = this.c
            , o = this.d;
          0 !== s || 0 !== r ? (this.a = e * n + i * r,
          this.b = e * s + i * o,
          this.c = -i * n + e * r,
          this.d = -i * s + e * o) : (this.a = e * n,
          this.b = i * o,
          this.c = -i * n,
          this.d = e * o),
          this.bTransform = !0
      ...
      t.mul = function(t, e, i) {
          var n = t.a
            ...
            , d = e.tx
            , f = e.ty;
          return 0 !== u || 0 !== c ? (i.a = n * l + s * c,
          i.b = n * u + s * _,
          i.c = r * l + o * c,
          i.d = r * u + o * _,
          i.tx = l * a + c * h + d,
          i.ty = u * a + _ * h + f) : (i.a = n * l,
          i.b = s * _,
          i.c = r * l,
          i.d = o * _,
          i.tx = l * a + d,
      ...
      t.mul16 = function(t, e, i) {
          var n = t.a
            ...
            , d = e.tx
            , f = e.ty;
          return 0 !== u || 0 !== c ? (i[0] = n * l + s * c,
          i[1] = n * u + s * _,
          i[4] = r * l + o * c,
          i[5] = r * u + o * _,
          i[12] = l * a + c * h + d,
          i[13] = u * a + _ * h + f) : (i[0] = n * l,
          i[1] = s * _,
          i[4] = r * l,
          i[5] = o * _,
          i[12] = l * a + d,
      ...
      t.mulPre = function(t, e, i, n, s, r, o, a) {
          var h = t.a
            ...
            , _ = t.tx
            , d = t.ty;
          return 0 !== i || 0 !== n ? (a.a = h * e + l * n,
          a.b = h * i + l * s,
          a.c = u * e + c * n,
          a.d = u * i + c * s,
          a.tx = e * _ + n * d + r,
          a.ty = i * _ + s * d + o) : (a.a = h * e,
          a.b = l * s,
          a.c = u * e,
          a.d = c * s,
          a.tx = e * _ + r,
      ...
      t.mulPos = function(t, e, i, n, s, r, o, a) {
          var h = t.a
            ...
            , _ = t.tx
            , d = t.ty;
          return 0 !== l || 0 !== u ? (a.a = e * h + i * u,
          a.b = e * l + i * c,
          a.c = n * h + s * u,
          a.d = n * l + s * c,
          a.tx = h * r + u * o + _,
          a.ty = l * r + c * o + d) : (a.a = e * h,
          a.b = i * c,
          a.c = n * h,
          a.d = s * c,
          a.tx = h * r + _,
    ...
    , P = function() {
      ...
      t._getBoundPointS = function(e, i, n, s) {
          var r = t._temA;
          return r.length = 0,
          0 == n || 0 == s ? r : (r.push(e, i, e + n, i, e, i + s, e + n, i + s),
          r)
      }
      ,
      t._getWrapRec = function(e, i) {
          ...
          i = i || new t;
          var n, s, r, o, a, h = e.length, l = S.TEMP;
          for (s = o = 99999,
          r = a = -s,
          n = 0; n < h; n += 2)
              l.x = e[n],
    ...
    , E = function() {
      function t() {}
      return s(t, "laya.media.SoundManager"),
      ...
      t.playSound = function(e, n, s, r, o) {
          ...
          var h;
          N.onMiniGame || (h = i.loader.getRes(e)),
          r || (r = t._soundClass),
          h || (h = new r,
          h.load(e),
          ot.cacheRes(e, h));
          var l;
          return (l = h.play(o, n)) ? (l.url = e,
    ...
    , I = function() {
      function e() {}
      var i;
      return s(e, "laya.net.LocalStorage"),
      e.__init__ = function() {
    ...
    , A = (function() {
      function t() {}
      s(t, "laya.net.ResourceVersion"),
      t.enable = function(e, n, s) {
          void 0 === s && (s = 2),
          laya.net.ResourceVersion.type = s,
          i.loader.load(e, l.create(null, t.onManifestLoaded, [n]), null, "json"),
          L.customFormat = t.addVersionPrefix
      }
      ,
  ...
  function() {
      ...
      return e.load = function(t) {
          ...
          N.window.conch ? this._loadConch() : N.window.FontFace ? this._loadWithFontFace() : this._loadWithCSS()
      }
      ,
      ...
      e._onHttpLoaded = function(t) {
          N.window.conch.setFontFaceFromBuffer(this.fontName, t),
          this._clearHttp(),
          this._complete()
      }
      ,
    ...
    , R = function() {
      function e(t, n) {
          ...
          o && e.WebGL.init(e._mainCanvas, t, n),
          N.container.appendChild(e._mainCanvas.source),
          e._context = new D(t,n,o ? null : e._mainCanvas),
          e._context.ctx.setIsMainContext(),
          N.window.requestAnimationFrame(s),
    ...
    , D = function() {
      function t(e, i, n) {
          ...
          this._drawCircle = function(e, i, n) {
              var s = this.ctx;
              R.isWebGL && s.setPathId(n[6]),
              $.drawCall++,
              s.beginPath(),
              R.isWebGL && s.movePath(n[0] + e, n[1] + i),
          ...
          this._drawLines = function(t, e, i) {
              ...
              var s = i[2]
                ...
                , o = s.length;
              if (R.isWebGL)
                  for (n.moveTo(s[0], s[1]); r < o; )
                      n.lineTo(s[r++], s[r++]);
              else
                  for (n.moveTo(t + s[0], e + s[1]); r < o; )
          ...
          this._drawPoly = function(t, e, i) {
              ...
              if (R.isWebGL)
                  ...
                  e += i[1],
                  n.movePath(t, e),
                  n.moveTo(s[0], s[1]); r < o; )
                      n.lineTo(s[r++], s[r++]);
              else
                  for (n.beginPath(),
                  t += i[0],
                  e += i[1],
                  n.moveTo(t + s[0], e + s[1]); r < o; )
                      n.lineTo(t + s[r++], e + s[r++]);
              n.closePath(),
          ...
          ,
          n ? this.ctx = n.getContext("2d") : (n = yt.create("3D"),
          this.ctx = o.createWebGLContext2D(n),
      ...
      e.drawRect = function(t, e, i, n, s, r) {
          ...
          o.strokeStyle = s,
          o.lineWidth = r,
          o.strokeRect(t + this.x, e + this.y, i, n, r)
      }
      ,
      e._fillAndStroke = function(t, e, i, n) {
          void 0 === n && (n = !1);
          var s = this.ctx;
          null != t && (s.fillStyle = t,
          R.isWebGL ? s.fill(n) : s.fill()),
          null != e && i > 0 && (s.strokeStyle = e,
          s.lineWidth = i,
          s.stroke())
      }
      ,
      ...
      e.drawCircle = function(e, i, n, s, r) {
          ...
          o.strokeStyle = s,
          o.lineWidth = r,
          o.arc(e + this.x, i + this.y, n, 0, t.PI2),
          o.stroke()
      }
      ,
      ...
      e.drawLine = function(t, e, i, n, s, r) {
          ...
          o.strokeStyle = s,
          o.lineWidth = r,
          o.moveTo(this.x + t, this.y + e),
          o.lineTo(this.x + i, this.y + n),
          o.stroke()
      }
      ,
      e.clear = function() {
    ...
    , F = function() {
      ...
      e._clip = function(e, i, n, s) {
          ...
          if (r != t.NORENDER) {
              ...
              i.ctx.save(),
              i.ctx.clipRect(n, s, o.width, o.height),
              r._fun.call(r, e, i, n - o.x, s - o.y),
              i.ctx.restore()
          }
      }
      ,
      ...
      e._transform = function(e, i, n, s) {
          var r = e.transform
            , o = this._next;
          r && o != t.NORENDER ? (i.save(),
          i.transform(r.a, r.b, r.c, r.d, r.tx + n, r.ty + s),
          o._fun.call(o, e, i, 0, 0),
          i.restore()) : o._fun.call(o, e, i, n, s)
      }
      ,
      e._childs = function(t, e, i, n) {
          var s = t._style
            , r = s._tf;
          if (i = i - r.translateX + s.paddingLeft,
      ...
      e._canvas = function(t, e, i, n) {
          ...
          if (!s)
              return void this._next._fun.call(this._next, t, e, i, n);
          "bitmap" === s.type ? $.canvasBitmap++ : $.canvasNormal++;
          var r = s.ctx;
          if (t._needRepaint() || !r)
      ...
      e._canvas_repaint = function(t, e, n, s) {
          var r = t._$P.cacheCanvas
            , o = this._next;
          if (!r)
              return void o._fun.call(o, t, c, n, s);
          var a, h, l, u, c = r.ctx, _ = t._needRepaint() || !c, d = r.type;
          if ("bitmap" === d ? $.canvasBitmap++ : $.canvasNormal++,
          _) {
              r._cacheRec || (r._cacheRec = new P);
              var f, p;
              R.isWebGL && "bitmap" !== d ? r._cacheRec.setTo(-t.pivotX, -t.pivotY, 1, 1) : (u = t.getSelfBounds(),
              u.x = u.x - t.pivotX,
              u.y = u.y - t.pivotY,
              u.x = u.x - 16,
              u.y = u.y - 16,
              ...
              u.x = Math.floor(u.x + n) - n,
              u.y = Math.floor(u.y + s) - s,
              u.width = Math.floor(u.width),
              u.height = Math.floor(u.height),
              r._cacheRec.copyFrom(u)),
              u = r._cacheRec;
              var g = R.isWebGL ? 1 : N.pixelRatio * i.stage.clientScaleX
                , m = R.isWebGL ? 1 : N.pixelRatio * i.stage.clientScaleY;
              if (!R.isWebGL) {
                  var v, y = 1, w = 1;
                  for (v = t; v && v != i.stage; )
                      y *= v.scaleX,
              ...
              h = u.x,
              l = u.y,
              R.isWebGL && "bitmap" === d && (f > 2048 || p > 2048))
                  return console.warn("cache bitmap size larger than 2048,cache ignored"),
                  r.ctx && (X.recover("RenderContext", r.ctx),
                  r.ctx.canvas.size(0, 0),
                  r.ctx = null),
                  void o._fun.call(o, t, e, n, s);
              c || (c = r.ctx = X.getItem("RenderContext") || new D(f,p,yt.create("AUTO"))),
              c.ctx.sprite = t,
              a = c.canvas,
              a.clear(),
              (a.width != f || a.height != p) && a.size(f, p),
              ...
              if (1 != g || 1 != m) {
                  ...
                  b.save(),
                  b.scale(g, m),
                  !R.isConchWebGL && R.isConchApp && (T = t._$P.cf) && b.setFilterMatrix && b.setFilterMatrix(T._mat, T._alpha),
                  o._fun.call(o, t, c, -h, -l),
                  b.restore(),
    ...
    , k = function() {
      ...
      e.drawTextures = function(t, e, i, n) {
          $.drawCall += e.length / 2;
          for (var s = t.width, r = t.height, o = 0, a = e.length; o < a; o += 2)
              this.drawTexture(t, e[o], e[o + 1], s, r, i, n)
      }
      ,
      e.drawCanvas = function(t, e, i, n, s) {
          $.drawCall++,
      ...
      e.drawTextureWithTransform = function(t, e, i, n, s, r, o, a, h) {
          ...
          r ? (this.transform(r.a, r.b, r.c, r.d, r.tx + o, r.ty + a),
          this.drawImage(t.source, l[0] * u, l[1] * c, (l[2] - l[0]) * u, (l[5] - l[3]) * c, e, i, n, s)) : this.drawImage(t.source, l[0] * u, l[1] * c, (l[2] - l[0]) * u, (l[5] - l[3]) * c, e + o, i + a, n, s),
          this.restore()
      }
      ,
      e.drawTexture2 = function(t, e, i, n, s, r, o, a) {
          ...
          if (h.loaded && h.bitmap && h.source) {
              ...
              this.drawImage(h.source, c[0] * _, c[1] * d, (c[2] - c[0]) * _, (c[5] - c[3]) * d, a[1] - i, a[2] - n, a[3], a[4]),
              this.restore()) : this.drawImage(h.source, c[0] * _, c[1] * d, (c[2] - c[0]) * _, (c[5] - c[3]) * d, a[1] - i + t, a[2] - n + e, a[3], a[4]),
      ...
      e.drawTriangle = function(t, e, i, n, s, r, o, a) {
          ...
          this.save(),
          o && this.transform(o.a, o.b, o.c, o.d, o.tx, o.ty),
          this.beginPath(),
          this.moveTo(w, b),
          this.lineTo(x, C),
          this.lineTo(T, M),
          this.closePath(),
          this.clip();
          var L = f * v + m * g + p * y - v * g - m * p - f * y
            , R = 1 / L
            , D = w * v + m * T + x * y - v * T - m * x - w * y
            , F = f * x + w * g + p * T - x * g - w * p - f * T
            , k = f * v * T + m * x * g + w * p * y - w * v * g - m * p * T - f * x * y
            , O = b * v + m * M + C * y - v * M - m * C - b * y
            , N = f * C + b * g + p * M - C * g - b * p - f * M
            , B = f * v * M + m * C * g + b * p * y - b * v * g - m * p * M - f * C * y;
          this.transform(D * R, O * R, F * R, N * R, k * R, B * R),
      ...
      t.__init__ = function(t) {
          ...
          if (t = t || CanvasRenderingContext2D.prototype,
          !t.inited) {
              t.inited = !0,
    ...
    , O = function() {
      ...
      e.addResource = function(t) {
          ...
          -1 === this._resources.indexOf(t) && (t._resourceManager = this,
      ...
      e.garbageCollection = function(t) {
          ...
          for (var i = $.loopCount, n = 0, s = e.length; n < s; n++) {
              var r = e[n];
  ...
  function() {
      function n() {}
      return s(n, "laya.utils.Browser"),
      r(1, n, "pixelRatio", function() {
          return n.__init__(),
          n.userAgent.indexOf("Mozilla/6.0(Linux; Android 6.0; HUAWEI NXT-AL10 Build/HUAWEINXT-AL10)") > -1 ? 2 : o.getPixelRatio() > 2 ? 2 : o.getPixelRatio()
      }),
      ...
      r(1, n, "clientHeight", function() {
          return n.__init__(),
          n.window.innerHeight || n.document.body.clientHeight || n.document.documentElement.clientHeight
      }),
      ...
      r(1, n, "container", function() {
          return n.__init__(),
          n._container || (n._container = n.createElement("div"),
          n._container.id = "layaContainer",
      ...
      n.__init__ = function() {
          n._window || (n._window = o.getWindow(),
          ...
          nt = n.webAudioEnabled ? st : et,
          n.webAudioEnabled && st.initWebAudio(),
          et._initMusicAudio(),
          n.enableTouch = "ontouchstart"in t || t.DocumentTouch && e instanceof DocumentTouch,
          t.focus(),
          E._soundClass = nt,
          E._musicClass = et,
          R._mainCanvas = R._mainCanvas || yt.create("2D"),
          n.canvas || (n.canvas = yt.create("2D"),
    ...
    , B = function() {
      ...
      ,
      e.rUTF = function(t) {
          for (var e = "", i = this._pos_ + t, n = 0, s = 0, r = 0, o = String.fromCharCode, a = this._u8d_, h = 0; this._pos_ < i; )
              n = a[this._pos_++],
              n < 128 ? 0 != n && (e += o(n)) : n < 224 ? e += o((63 & n) << 6 | 127 & a[this._pos_++]) : n < 240 ? (s = a[this._pos_++],
              e += o((31 & n) << 12 | (127 & s) << 6 | 127 & a[this._pos_++])) : (s = a[this._pos_++],
              r = a[this._pos_++],
              e += o((15 & n) << 18 | (127 & s) << 12 | r << 6 & 127 | 127 & a[this._pos_++])),
              h++;
          return e
      }
      ,
    ...
    , W = function() {
      function t() {}
      return s(t, "laya.utils.CacheManager"),
      ...
      t._checkLoop = function() {
          ...
          if (!(e.length < 1)) {
              var i = N.now()
                , n = 0
                , s = 0;
              for (s = n = e.length; n > 0 && (t._index++,
              t._index = t._index % s,
              e[t._index].tryDispose(!1),
              !(N.now() - i > t.loopTimeLimit)); )
                  n--
          }
      }
      ,
    ...
    , G = function() {
      function t() {}
      return s(t, "laya.utils.ClassUtils"),
      ...
      t.createByJson = function(e, i, n, s, r) {
          ...
          var o = e.props;
          if (!i && !(i = r ? r.runWith(e) : t.getInstance(o.runtime || e.type)))
              return null;
          var a = e.child;
          if (a)
              for (var h = 0, l = a.length; h < l; h++) {
                  ...
                  if ("render" !== u.props.name && "render" !== u.props.renderType || !i._$set_itemRender)
                      if ("Graphic" == u.type)
                          t.addGraphicsToSprite(u, i);
                      else if (t.isDrawType(u.type))
                          t.addGraphicToSprite(u, i, !0);
                      else {
      ...
      t.addGraphicsToSprite = function(e, i) {
          ...
          if ((n = e.child) && !(n.length < 1)) {
              ...
              o = t._getObjVar(e.props, "y", 0)),
              0 != r && 0 != o && s.translate(r, o);
              var a = 0
                , h = 0;
              for (h = n.length,
              a = 0; a < h; a++)
                  t._addGraphicToGraphics(n[a], s);
              0 != r && 0 != o && s.translate(-r, -o)
          }
      }
      ,
      ...
      t._getTransformData = function(e) {
          var i;
          (e.hasOwnProperty("pivotX") || e.hasOwnProperty("pivotY")) && (i = i || new M,
      ...
      t._getParams = function(e, i, n, s) {
          ...
          for (a = i.length,
          o = 0; o < a; o++)
              r[o] = t._getObjVar(e, i[o][0], i[o][1]);
  ...
  function() {
      ...
      ,
      e.stop = function() {
          this._dragging && (v.instance.disableMouseEvent = !1,
      ...
      e.loop = function() {
          var t = this._parent.getMousePoint()
            ...
            , r = n - this._lastY;
          if (this._clickOnly) {
              if (!(Math.abs(s * i.stage._canvasTransform.getScaleX()) > 1 || Math.abs(r * i.stage._canvasTransform.getScaleY()) > 1))
                  return;
              this._clickOnly = !1,
              ...
              this._offsets.push(s, r);
          0 === s && 0 === r || (this._lastX = e,
          this._lastY = n,
          this.target.x += s * this._elasticRateX,
      ...
      e.onStageMouseUp = function(t) {
          if (v.instance.disableMouseEvent = !1,
          i.stage.off("mouseup", this, this.onStageMouseUp),
          i.stage.off("mouseout", this, this.onStageMouseUp),
          i.timer.clear(this, this.loop),
          !this._clickOnly && this.target)
              if (this.hasInertia) {
                  ...
                  for (var e = this._offsets.length, n = Math.min(e, 6), s = this._offsets.length - n, r = e - 1; r > s; r--)
      ...
      e.checkElastic = function() {
          ...
          isNaN(t) && isNaN(e))
              ...
              isNaN(t) || (i.x = t),
              isNaN(e) || (i.y = e),
              this._tween = j.to(this.target, i, this.elasticBackTime, Y.sineOut, l.create(this, this.clear), 0, !1, !1)
          }
      }
      ,
    ...
    , Y = function() {
      ...
      t.elasticIn = function(e, i, n, s, r, o) {
          ...
          a = o / 4) : a = o / t.PI2 * Math.asin(n / r),
          -r * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * s - a) * t.PI2 / o) + i)
      }
      ,
      t.elasticInOut = function(e, i, n, s, r, o) {
          ...
          void 0 === o && (o = 0);
          var a;
          return 0 == e ? i : 2 == (e /= .5 * s) ? i + n : (o || (o = s * (.3 * 1.5)),
          !r || n > 0 && r < n || n < 0 && r < -n ? (r = n,
          a = o / 4) : a = o / t.PI2 * Math.asin(n / r),
          e < 1 ? r * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * s - a) * t.PI2 / o) * -.5 + i : r * Math.pow(2, -10 * (e -= 1)) * Math.sin((e * s - a) * t.PI2 / o) * .5 + n + i)
      }
      ,
      t.elasticOut = function(e, i, n, s, r, o) {
          ...
          !r || n > 0 && r < n || n < 0 && r < -n ? (r = n,
          a = o / 4) : a = o / t.PI2 * Math.asin(n / r),
          r * Math.pow(2, -10 * e) * Math.sin((e * s - a) * t.PI2 / o) + n + i)
      }
      ,
  ...
  function() {
      ...
      s(t, "laya.utils.Log"),
      t.enable = function() {
          t._logdiv || (t._logdiv = N.window.document.createElement("div"),
          N.window.document.body.appendChild(t._logdiv),
  ...
  function() {
    ...
    , $ = (function() {
      ...
      e.getCacheList = function() {
          return X.getPoolBySign(this.sign)
      }
      ,
      e.tryDispose = function(t) {
          var e;
          e = X.getPoolBySign(this.sign),
      ...
      t.addPoolCacheManager = function(e, i) {
          ...
          n.sign = e,
          n.maxCount = i,
          W.regCacheByFunction(K.bind(n.tryDispose, n), K.bind(n.getCacheList, n))
      }
  }(),
  function() {
      function t() {}
      return s(t, "laya.utils.Stat"),
      ...
      t.show = function(e, i) {
          if (void 0 === e && (e = 0),
          void 0 === i && (i = 0),
          R.isConchApp && !R.isConchWebGL)
              return void (N.window.conch.showFPS && N.window.conch.showFPS(e, i));
          R.isConchWebGL || N.onMiniGame || N.onLimixiu || (t._useCanvas = !0),
          t._show = !0,
          ...
          R.is3DMode ? (t._view[0].title = "FPS(3D)",
          t._view[5] = {
              title: "TriFaces",
      ...
      t.createUIPre = function(e, i) {
          ...
          t._canvas || (t._canvas = new yt("2D"),
          t._canvas.size(t._width, t._height),
          t._ctx = t._canvas.getContext("2d"),
          t._ctx.textBaseline = "top",
          ...
          t.loop(),
          t._first = !1,
          N.container.appendChild(t._canvas.source)
      }
      ,
      t.createUI = function(e, i) {
          ...
          n.graphics.drawRect(0, 0, a, h, "#999999"),
      ...
      t.hide = function() {
          ...
          t._canvas && N.removeElement(t._canvas.source)
      }
      ,
      t.clear = function() {
      ...
      t.loop = function() {
          ...
          if (!(e - t._timer < 1e3)) {
              ...
              t._show) {
                  ...
                  t.currentMemorySize = O.systemResourceManager.memorySize,
      ...
      t.renderInfoPre = function() {
          if (t._canvas) {
              ...
              for (var i = 0; i < t._view.length; i++) {
                  ...
                  e.fillStyle = n.color;
                  var s = t[n.value];
                  "M" == n.units && (s = Math.floor(s / 1048576 * 100) / 100 + " M"),
      ...
      t.renderInfo = function() {
          for (var e = "", i = 0; i < t._view.length; i++) {
              var n = t._view[i]
                , s = t[n.value];
              "M" == n.units && (s = Math.floor(s / 1048576 * 100) / 100 + " M"),
              "K" == n.units && (s = Math.floor(s / 1024 * 100) / 100 + " K"),
              e += s + "\n"
          }
          t._txt.text = e
      }
  ...
  function() {
      ...
      n._update = function() {
          if (this.scale <= 0)
              return void (this._lastTimer = this._now());
      ...
      n._create = function(i, n, s, r, o, a, h) {
          ...
          if (h) {
              ...
              if (l)
                  ...
                  l.method = o,
                  l.args = a,
                  l.exeTime = s + (i ? this.currFrame : this.currTimer + this._now() - this._lastTimer),
                  l
          }
          ...
          l.method = o,
          l.args = a,
          l.exeTime = s + (i ? this.currFrame : this.currTimer + this._now() - this._lastTimer) + 1,
    ...
    , j = function() {
      ...
      return e.to = function(t, e, i, n, s, r, o) {
          return void 0 === r && (r = 0),
          void 0 === o && (o = !1),
          this._create(t, e, i, n, s, r, o, !0, !1, !0)
      }
      ,
      e.from = function(t, e, i, n, s, r, o) {
          return void 0 === r && (r = 0),
          void 0 === o && (o = !1),
          this._create(t, e, i, n, s, r, o, !1, !1, !0)
      }
      ,
      e._create = function(e, n, s, r, o, a, h, l, u, c) {
          ...
          this._complete = o || n.complete,
          this._delay = a,
          this._props = [],
          this._usedTimer = 0,
          this._startTimer = N.now(),
          this._usedPool = u,
          ...
          c ? a <= 0 ? this.firstStart(e, n, l) : (this._delayParam = [e, n, l],
          i.scaleTimer.once(a, this, this.firstStart, this._delayParam)) : this._initProps(e, n, l),
          this
      }
      ,
      e.firstStart = function(t, e, i) {
          if (this._delayParam = null,
          t.destroyed)
      ...
      e.pause = function() {
          ...
          var t = N.now()
            , e = NaN;
          (e = t - this._startTimer - this._delay) < 0 && (this._usedTimer = e)
      }
      ,
      ...
      e.restart = function() {
          ...
          this._startTimer = N.now(),
          this._delayParam)
              return void i.scaleTimer.once(this._delay, this, this.firstStart, this._delayParam);
      ...
      t.to = function(e, i, n, s, r, o, a, h) {
          ...
          void 0 === a && (a = !1),
          void 0 === h && (h = !0),
          X.getItemByClass("tween", t)._create(e, i, n, s, r, o, a, !0, h, !0)
      }
      ,
      t.from = function(e, i, n, s, r, o, a, h) {
          ...
          void 0 === a && (a = !1),
          void 0 === h && (h = !0),
          X.getItemByClass("tween", t)._create(e, i, n, s, r, o, a, !1, h, !0)
      }
      ,
    ...
    , K = function() {
      ...
      t.updateOrder = function(t) {
          ...
          if (o)
              if (null != o.updateZOrder)
                  o.updateZOrder();
              else {
                  for (i = 0; i < s; i++)
                      o.removeChild(t[i].conchModel);
                  for (i = 0; i < s; i++)
                      o.addChildAt(t[i].conchModel, i)
              }
          return !0
      }
      ,
      ...
      t.getTransformRelativeToWindow = function(t, e, n) {
          var s = i.stage
            ...
            , a = o.tx
            , h = o.ty;
          o.rotate(-Math.PI / 180 * i.stage.canvasDegree),
          o.scale(i.stage.clientScaleX, i.stage.clientScaleY);
          ...
          var _ = NaN
            , d = NaN;
          return l ? (_ = o.d * r.height,
          d = o.a * r.width) : (_ = o.a * r.width,
          d = o.d * r.height),
          {
              x: u,
              y: c,
    ...
    , q = function() {
      function t() {
          ...
          this._checkKey = !1,
          this._freeIdArray = [],
          R.isWebGL && W.regCacheByFunction(K.bind(this.startDispose, this), K.bind(this.getCacheList, this))
      }
    ...
    , Q = function() {
      function t() {
          this._obj = null,
          this._obj = t.supportWeakMap ? new N.window.WeakMap : {},
      ...
      return e.set = function(e, i) {
          if (null != e)
              if (t.supportWeakMap) {
                  ...
                  "string" == typeof e || "number" == typeof e ? this._obj[e] = i : (e.$_GID || (e.$_GID = K.getGID()),
                  this._obj[e.$_GID] = i)
      }
      ,
      e.get = function(e) {
      ...
      ,
      t.__init__ = function() {
          t.supportWeakMap = null != N.window.WeakMap,
          t.supportWeakMap || i.timer.loop(t.delInterval, null, t.clearCache)
      }
      ,
    ...
    , tt = function(t) {
      ...
      i._calculation = function(t, e) {
          ...
          function n(t) {
              var e = r.width
                , n = s.width;
              o.width && (s.width = i(e, n, o.width)),
              o.height && (s.height = i(e, n, o.height)),
              o.left && (s.x = i(e, n, o.left)),
              o.top && (s.y = i(e, n, o.top))
          }
          if (e.indexOf("%") < 0)
              return !1;
          var s = this._ower
            , r = s.parent
            , o = this._rect;
          null === o && (r._getCSSStyle()._type |= 524288,
          r.on("resize", this, n),
          this._rect = o = {
              input: {}
          });
          var a = e.split(" ");
          return a[0] = parseFloat(a[0]) / 100,
          1 == a.length ? a[1] = a[2] = 0 : (a[1] = parseFloat(a[1]) / 100,
          a[2] = parseFloat(a[2])),
          o[t] = a,
          o.input[t] = e,
          n(t),
      ...
      i.translate = function(t, e) {
          this._tf === c._TF_EMPTY && (this._tf = new d),
      ...
      r(0, i, "background", null, function(t) {
          if (!t)
              return void (this._bgground = null);
      ...
      r(0, i, "border", function() {
          ...
          if ("none" == t)
              return void (this._border = null);
          this._border || (this._border = {}),
          this._border.value = t;
          var e = t.split(" ");
          if (this._border.color = U.create(e[e.length - 1]),
          1 == e.length)
      ...
      r(0, i, "borderColor", function() {
          ...
          this._border.color = null == t ? null : U.create(t),
          ...
          for (var n, s = [], r = t.split(i), o = 0, a = r.length; o < a; o++) {
              ...
              if (0 != u.length) {
                  ...
                  case "padding":
                      ...
                      _[1] = [parseInt(n[0]), parseInt(n[1]), parseInt(n[2]), parseInt(n[3])];
                      break;
                  case "rotate":
                      _[0] = "_rotate",
                      _[1] = parseFloat(c);
    ...
    , et = function(t) {
      ...
      i.load = function(t) {
          ...
          this.url = t;
          var r;
          if (t == E._tMusic ? (e._initMusicAudio(),
          r = e._musicAudio,
          r.src != t && (e._audioCache[r.src] = null,
          r = null)) : r = e._audioCache[t],
          r && r.readyState >= 2)
              return void this.event("complete");
          r || (t == E._tMusic ? (e._initMusicAudio(),
          r = e._musicAudio) : r = N.createElement("audio"),
          e._audioCache[t] = r,
          r.src = t),
      ...
      i.play = function(t, i) {
          ...
          !this.url)
              return null;
          var n;
          if (!(n = this.url == E._tMusic ? e._musicAudio : e._audioCache[this.url]))
              return null;
          var s;
          s = X.getItem("audio:" + this.url),
          R.isConchApp ? s || (s = N.createElement("audio"),
          s.src = this.url) : this.url == E._tMusic ? (e._initMusicAudio(),
          s = e._musicAudio,
          s.src = this.url) : s = s || n.cloneNode(!0);
          var r = new _t(s);
      ...
      e._initMusicAudio = function() {
          e._musicAudio || (e._musicAudio || (e._musicAudio = N.createElement("audio")),
          R.isConchApp || N.document.addEventListener("mousedown", e._makeMusicOK))
      }
      ,
      e._makeMusicOK = function() {
          N.document.removeEventListener("mousedown", e._makeMusicOK),
    ...
    , st = function(t) {
      ...
      return i.load = function(t) {
          ...
          this.audioBuffer)
              return void this._loaded(this.audioBuffer);
          if (e.e.on("loaded:" + t, this, this._loaded),
          ...
          !e.__loadingSound[t]) {
              ...
              n.onload = function() {
                  if (i._disposed)
                      return void i._removeLoadEvents();
                  i.data = n.response,
                  e.buffs.push({
                      buffer: i.data,
                      url: i.url
      ...
      e._unlock = function() {
          ...
          "running" == e.ctx.state && (N.document.removeEventListener("mousedown", e._unlock, !0),
          N.document.removeEventListener("touchend", e._unlock, !0),
          e._unlocked = !0))
      }
      ,
      e.initWebAudio = function() {
          "running" != e.ctx.state && (e._unlock(),
          N.document.addEventListener("mousedown", e._unlock, !0),
    ...
    , rt = function(t) {
      function e() {
          ...
          this._data = null,
          e.__super.call(this),
          this._http = new N.window.XMLHttpRequest
      }
      ...
      return i.send = function(t, e, i, n, s) {
          ...
          s)
              for (var a = 0; a < s.length; a++)
                  o.setRequestHeader(s[a++], s[a]);
          else
              R.isConchApp || (e && "string" != typeof e ? o.setRequestHeader("Content-Type", "application/json") : o.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"));
          o.responseType = "arraybuffer" !== n ? "text" : "arraybuffer",
    ...
    , ot = function(t) {
      ...
      n._loadImage = function(t) {
          ...
          var n, s = this, r = function() {
              ...
              i(),
              s.event("error", "Load image failed")
          };
          "nativeimage" === this._type ? (n = new N.window.Image,
          n.crossOrigin = "",
          n.onload = r,
          n.onerror = o,
          n.src = t,
          e.imgCache[t] = n) : new Tt.create(t,{
              onload: r,
              onerror: o,
              onCreate: function(i) {
                  n = i,
          ...
          if ("image" === i) {
              ...
              if (!t.src && !t._setContext) {
                  if (!this._data) {
                      if (this._data = t,
                      t.meta && t.meta.image)
                          for (var s = t.meta.image.split(","), r = this._url.indexOf("/") >= 0 ? "/" : "\\", o = this._url.lastIndexOf(r), a = o >= 0 ? this._url.substr(0, o + 1) : "", h = 0, l = s.length; h < l; h++)
                              s[h] = a + s[h];
                      else
              ...
              var T = new u;
              T.parseFont(this._data, t);
              var b = this._url.split(".fnt")[0].split("/")
                , C = b[b.length - 1];
              gt.registerBitmapFont(C, T),
              this._data = T,
              this.complete(this._data)
          } else if ("pkm" == i) {
              var M = Tt.create(t, this._url)
                , S = new lt(M);
              S.url = this._url,
              this.complete(S)
          } else
      ...
      e.checkNext = function() {
          e._isWorking = !0;
          for (var t = N.now(); e._startIndex < e._loaders.length; )
              if (N.now(),
              e._loaders[e._startIndex].endLoad(),
              e._startIndex++,
              N.now() - t > e.maxTimeOut)
                  return console.warn("loader callback cost a long time:" + (N.now() - t) + " url=" + e._loaders[e._startIndex - 1].url),
      ...
      ,
      e.getRes = function(t) {
          return e.loadedMap[L.formatURL(t)]
      }
      ,
      e.getAtlas = function(t) {
          return e.atlasMap[L.formatURL(t)]
      }
      ,
    ...
    , at = function(t) {
      ...
      return o.create = function(t, e, i, n, s, r, o, a) {
          ...
          t instanceof Array) {
              var h = function(t, i) {
                ...
                , d = 0;
              if (i)
                  var f = l.create(i.caller, i.method, i.args, !1);
              for (var p = 0; p < _; p++) {
                  var g = c[p];
      ...
      o._create = function(t, n, s, r, o, a, h, u) {
          ...
          var c = L.formatURL(t)
            , _ = this.getRes(c);
          if (_)
              !_.hasOwnProperty("loaded") || _.loaded ? (s && s.runWith(1),
              n && n.run()) : n && i.loader._createListener(t, n.caller, n.method, n.args, !0, !1);
          else {
              var d = K.getFileExtension(t)
                , f = e.createMap[d];
              if (!f)
              ...
              var p = f[1];
              if ("atlas" == d)
                  this.load(t, n, s, p, a, h);
              else {
                  var g = function(e) {
                      _ && !_.destroyed && e && _.onAsynLoaded.call(_, t, e, o),
                      n && n.run(),
                      i.loader.event(t)
                  };
                  r === lt && (p = "htmlimage"),
                  _ = r ? new r : null,
                  _.hasOwnProperty("_loaded") && (_._loaded = !1),
                  _._setUrl(t),
                  u && _._setGroup(u),
                  this._createLoad(_, t, l.create(null, g), s, p, a, !1, u, !0),
                  h && this.cacheRes(c, _)
              }
          }
          return _
      ...
      o.load = function(t, n, s, o, a, h, l, u) {
          ...
          void 0 === u && (u = !1),
          t instanceof Array)
              return this._loadAssets(t, n, s, o, a, h, l);
          var _ = ot.getRes(t);
          if (null != _)
              ...
              s && d._createListener("progress", s.caller, s.method, s.args, !1, !1)) : (d = this._infoPool.length ? this._infoPool.pop() : new r,
              d.url = t,
              d.type = o,
              d.cache = h,
              d.group = l,
              ...
              s && d.on("progress", s.caller, s.method, s.args),
              e._resMap[t] = d,
              a = a < this._maxPriority ? a : this._maxPriority - 1,
              this._resInfos[a].push(d),
              this._next())
          }
          return this
      }
      ...
      o._createLoad = function(t, n, s, o, a, h, l, u, c) {
          ...
          void 0 === c && (c = !1),
          n instanceof Array)
              return this._loadAssets(n, s, o, a, h, l, u);
          var d = ot.getRes(n);
          if (null != d)
              i.timer.frameOnce(1, null, function() {
                  o && o.runWith(1),
              ...
              var f = e._resMap[n];
              f ? (s && f._createListener("complete", s.caller, s.method, s.args, !1, !1),
              o && f._createListener("progress", o.caller, o.method, o.args, !1, !1)) : (f = this._infoPool.length ? this._infoPool.pop() : new r,
              f.url = n,
              f.clas = t,
              f.type = a,
              f.cache = l,
              f.group = u,
              f.ignoreCache = c,
              s && f.on("complete", s.caller, s.method, s.args),
              o && f.on("progress", o.caller, o.method, o.args),
              e._resMap[n] = f,
      ...
      o._loadAssets = function(t, e, i, n, s, r, o) {
          ...
          void 0 === s && (s = 1),
          void 0 === r && (r = !0);
          for (var u = t.length, c = 0, _ = 0, d = [], f = !0, p = 0; p < u; p++) {
              var g = t[p];
              "string" == typeof g && (g = {
                  url: g,
                  type: n,
  ...
  function(t) {
      ...
      i.connectByUrl = function(t) {
          ...
          this.protocols && 0 != this.protocols.length ? this._socket = new N.window.WebSocket(t,this.protocols) : this._socket = new N.window.WebSocket(t),
      ...
      i._onMessage = function(t) {
          if (t && t.data) {
              ...
              if (this.disableInput && e)
                  return void this.event("message", e);
  ...
  function(t) {
      function e() {
          ...
          e.__super.call(this);
          var t = this;
          this.worker = new N.window.Worker(e.workerPath),
      ...
      i.imageLoaded = function(t) {
          ...
          case "buffer":
              i = new yt("2D"),
              n = i.source.getContext("2d"),
              s = n.createImageData(t.width, t.height),
              s.data.set(t.buffer),
          ...
          case "imageBitmap":
              s = t.imageBitmap,
              R.isWebGL ? i = s : (i = new yt("2D"),
              n = i.source.getContext("2d"),
              i.size(s.width, s.height),
              n.drawImage(s, 0, 0),
              i.src = t.url)
          }
          R.isWebGL && (i = new laya.webgl.resource.WebGLImage(i,t.url)),
          this.event(t.url, i)
      }
      ,
      ...
      i._loadImage = function(t) {
          ...
          if (!e._enable || t.toLowerCase().indexOf(".png") < 0)
              return void e._preLoadFun.call(n, t);
          t = L.formatURL(t);
          var s = function(s) {
              i(),
      ...
      r(1, e, "enable", function() {
          ...
          e.disableJSDecode && !N.window.createImageBitmap || (e._enable = t,
          e._enable && null == e._preLoadFun && (e._enable = e.__init__()))
      }),
      e.__init__ = function() {
          return null == e._preLoadFun && (!!N.window.Worker && (e._preLoadFun = ot.prototype._loadImage,
          ot.prototype._loadImage = e.prototype._loadImage,
          e.I || (e.I = new e),
          !0))
      }
      ,
  ...
  function(t) {
      function e() {
          ...
          O.currentResourceManager && O.currentResourceManager.addResource(this)
      }
      ...
      n._setUrl = function(t) {
          if (this._url !== t) {
              var i;
              this._url && (i = e._urlResourcesMap[this._url],
              i.splice(i.indexOf(this), 1),
              0 === i.length && delete e._urlResourcesMap[this._url]),
              t && (i = e._urlResourcesMap[t],
              i || (e._urlResourcesMap[t] = i = []),
              i.push(this)),
              this._url = t
          }
      }
      ...
      n._setGroup = function(t) {
          if (this._group !== t) {
              var i;
              this._group && (i = e._groupResourcesMap[this._group],
              i.splice(i.indexOf(this), 1),
              0 === i.length && delete e._groupResourcesMap[this._group]),
              t && (i = e._groupResourcesMap[t],
              i || (e._groupResourcesMap[t] = i = []),
              i.push(this)),
              this._group = t
          }
      }
      ...
      n.activeResource = function(t) {
          void 0 === t && (t = !1),
          this._lastUseFrameCount = $.loopCount,
      ...
      n.destroy = function() {
          if (!this._destroyed) {
              ...
              var t;
              this._url && (t = e._urlResourcesMap[this._url],
              ...
              this._group && (t = e._groupResourcesMap[this._group],
      ...
      e.destroyUnusedResources = function(t) {
          ...
          if (t) {
              ...
              if (n)
                  for (var s = n.slice(), r = 0, o = s.length; r < o; r++)
                      i = s[r],
                      i.lock || 0 !== i._referenceCount || i.destroy()
          } else
              for (var a in e._idResourcesMap)
                  i = e._idResourcesMap[a],
                  i.lock || 0 !== i._referenceCount || i.destroy()
      }
      ,
    ...
    , lt = function(e) {
      ...
      a.getPixels = function(t, e, i, n) {
          ...
          N.canvas.clear(),
          N.context.drawTexture(this, -t, -e, this.width, this.height, 0, 0),
      ...
      r(0, a, "repeat", function() {
          ...
          t && R.isWebGL && this.bitmap && (this.bitmap.repeat = t,
      ...
      n.create = function(t, e, i, s, r, a, h, l, u) {
          ...
          m.uv = [w + S[0] * C, x + S[1] * M, T - (1 - S[2]) * C, x + S[3] * M, T - (1 - S[4]) * C, b - (1 - S[5]) * M, w + S[6] * C, b - (1 - S[7]) * M],
          f && m.addTextureToAtlas();
          var P = d.scaleRate;
          return P && 1 != P ? (m.sourceWidth /= P,
          m.sourceHeight /= P,
          m.width /= P,
          m.height /= P,
          m.scaleRate = P,
          m.offsetX /= P,
          m.offsetY /= P) : m.scaleRate = 1,
          m
      }
      ,
    ...
    , ut = function(t) {
      ...
      o._create = function(t, e, i, s, r, o) {
          var a = X.getItemByClass("tweenData", n);
          return a.isTo = o,
          a.type = 0,
          a.target = t,
          a.duration = i,
          a.data = e,
          a.startTime = this._startTime + r,
          a.endTime = a.startTime + a.duration,
          a.ease = s,
          this._startTime = Math.max(a.endTime, this._startTime),
          this._tweenDataList.push(a),
      ...
      o.addLabel = function(t, e) {
          var i = X.getItemByClass("tweenData", n);
          return i.type = 1,
          i.data = t,
      ...
      o.gotoTime = function(t) {
          if (null != this._tweenDataList && 0 != this._tweenDataList.length) {
              ...
              this._gidIndex = 0,
              this._currTime = t,
              this._lastTime = N.now();
              var r;
              if (null == this._endTweenDataList || this._endTimeSort) {
                  var o = function(t, e) {
              ...
              for (var a, h = 0, u = r.length; h < u; h++)
                  if (a = r[h],
                  0 == a.type) {
                      if (!(t >= a.endTime))
                          break;
              ...
              for (h = 0,
              u = this._tweenDataList.length; h < u; h++)
                  a = this._tweenDataList[h],
                  0 == a.type && t >= a.startTime && t < a.endTime && (this._index = Math.max(this._index, h + 1),
                  this._gidIndex++,
                  e = X.getItemByClass("tween", j),
                  e._create(a.target, a.data, a.duration, a.ease, l.create(this, this._animComplete, [this._gidIndex]), 0, !1, a.isTo, !0, !1),
                  ...
                  for (var s = 0, r = this._tweenDataList.length; s < r; s++) {
                      ...
                      if (null != o && 0 == o.type) {
                          var a = o.target
                            ...
                            , l = null;
                          null == this._firstTweenDic[h] ? (l = {},
                          l.diyTarget = a,
                          this._firstTweenDic[h] = l) : l = this._firstTweenDic[h];
                          for (var u in o.data)
                              null == l[u] && (l[u] = a[u])
                      }
                  }
      ...
      o._update = function() {
          ...
          if (0 != this._tweenDataList.length && this._index < this._tweenDataList.length) {
              ...
              s = X.getItemByClass("tween", j),
              s._create(r.target, r.data, r.duration, r.ease, l.create(this, this._animComplete, [this._gidIndex]), 0, !1, r.isTo, !0, !1),
              s.setStartTime(n),
              s.gid = this._gidIndex,
              this._tweenDic[this._gidIndex] = s,
              s._updateEase(n)) : this.event("label", r.data))
          }
      }
      ,
      ...
      o.reset = function() {
          ...
          this._tweenDataList && this._tweenDataList.length) {
              ...
              n = 0; n < s; n++)
                  this._tweenDataList[n] && this._tweenDataList[n].destroy()
          }
    ...
    , ct = function(e) {
      ...
      h.getBounds = function() {
          return this._$P.mBounds || this._set$P("mBounds", new P),
          P._getWrapRec(this._boundPointsToParent(), this._$P.mBounds)
      }
      ,
      h.getSelfBounds = function() {
          return this._$P.uBounds ? this._$P.uBounds : (this._$P.mBounds || this._set$P("mBounds", new P),
          P._getWrapRec(this._getBoundPointsM(!1), this._$P.mBounds))
      }
      ,
      h._boundPointsToParent = function(t) {
          ...
          if (!n || n.length < 1)
              return n;
          if (8 != n.length && (n = t ? b.scanPList(n) : P._getWrapRec(n, P.TEMP)._getBoundPoints()),
          !this.transform)
              return K.transPointList(n, this._x - e, this._y - i),
              n;
          var s = S.TEMP
            , r = 0
            , o = n.length;
      ...
      h.getGraphicBounds = function(t) {
          return void 0 === t && (t = !1),
          this._graphics ? this._graphics.getBounds(t) : P.TEMP.setTo(0, 0, 0, 0)
      }
      ,
      h._getBoundPointsM = function(t) {
          ...
          this.scrollRect) {
              ...
              K.concatArray(e, i._getBoundPoints()),
              e
          }
          var n, s, r, o = this._graphics ? this._graphics.getBoundPoints() : K.clearArray(this._$P.temBM);
          r = this._childs;
          for (var a = 0, h = r.length; a < h; a++)
              (n = r[a])instanceof laya.display.Sprite && 1 == n.visible && (s = n._boundPointsToParent(t)) && (o = o ? K.concatArray(o, s) : s);
          return o
      }
      ,
      h.getStyle = function() {
          return this._style === c.EMPTY && (this._style = new c),
          this._style
      }
      ,
      ...
      h._adjustTransform = function() {
          this._tfChanged = !1;
          var t, e = this._style, i = e._tf, n = i.scaleX, s = i.scaleY;
          if (i.rotate || 1 !== n || 1 !== s || i.skewX || i.skewY) {
              t = this._transform || (this._transform = M.create()),
              t.bTransform = !0;
      ...
      h.render = function(t, e, i) {
          $.spriteCount++,
          F.renders[this._renderType]._fun(this, t, e + this._x, i + this._y),
          this._repaint = 0
      }
      ,
      h.drawToCanvas = function(t, e, i, n) {
          if (R.isConchNode) {
              var s = yt.create("2D");
              return new D(t,e,s).ctx.setCanvasType(1),
      ...
      h.globalToLocal = function(t, e) {
          void 0 === e && (e = !1),
          e && (t = new S(t.x,t.y));
          for (var n = this, s = []; n && n != i.stage; )
              s.push(n),
              n = n.parent;
          for (var r = s.length - 1; r >= 0; )
              n = s[r],
              t = n.fromParentPoint(t),
              r--;
          return t
      }
      ,
      ...
      h.on = function(t, i, n, s) {
          ...
          this._createListener(t, i, n, s, !1)) : e.prototype.on.call(this, t, i, n, s)
      }
      ,
      h.once = function(t, i, n, s) {
          ...
          this._setBit(2, !0),
          this._parent && this._$2__onDisplay(),
          this._createListener(t, i, n, s, !0)) : e.prototype.once.call(this, t, i, n, s)
      }
      ,
      ...
      h.loadImage = function(t, e, i, n, s, r) {
          function o(t) {
              a.destroyed || (a.size(e + (n || t.width), i + (s || t.height)),
              a.repaint(),
              r && r.runWith(t))
          }
          var a = this;
      ...
      h.startDrag = function(t, e, i, n, s, r, o) {
          ...
          void 0 === r && (r = !1),
          void 0 === o && (o = .92),
          this._$P.dragging || this._set$P("dragging", new z),
      ...
      h._releaseMem = function() {
          if (this._$P) {
              ...
              t && t.ctx && (X.recover("RenderContext", t.ctx),
      ...
      h.hitTestPoint = function(t, e) {
          ...
          return t = i.x,
          e = i.y,
          (this._$P.hitArea ? this._$P.hitArea : this._width > 0 && this._height > 0 ? P.TEMP.setTo(0, 0, this._width, this._height) : this.getSelfBounds()).contains(t, e)
      }
      ,
      ...
      r(0, h, "customRenderEnable", null, function(t) {
          ...
          R.isConchNode)) {
              ...
              this.customContext = new D(0,0,e),
      ...
      r(0, h, "cacheAs", function() {
          ...
          if (t !== (e ? e.type : "none")) {
              if ("none" !== t)
                  this._getBit(1) || this._setUpNoticeType(1),
                  e || (e = this._set$P("cacheCanvas", X.getItemByClass("cacheCanvas", Object))),
                  e.type = t,
                  e.reCache = !0,
                  this._renderType |= 16,
                  ...
                  if (e) {
                      var i = e;
                      i && i.ctx && (X.recover("RenderContext", i.ctx),
                      i.ctx.canvas.size(0, 0),
                      i.ctx = null),
                      X.recover("cacheCanvas", e)
                  }
      ...
      r(0, h, "mask", function() {
          ...
          this._set$P("_mask", t),
          t._set$P("maskParent", this)) : (this.cacheAs = "none",
    ...
    , _t = function(t) {
      function e(t) {
          ...
          e.__super.call(this),
          this._onEnd = K.bind(this.__onEnd, this),
          this._resumePlay = K.bind(this.__resumePlay, this),
      ...
      n.__resumePlay = function() {
          ...
          try {
              ...
              N.container.appendChild(this._audio),
              this._audio.play()
          } catch (t) {
              this.event("error")
          }
      ...
      n.stop = function() {
          ...
          N.onIE || this._audio != et._musicAudio && X.recover("audio:" + this.url, this._audio),
          N.removeElement(this._audio),
          this._audio = null)
      }
      ,
      n.pause = function() {
    ...
    , dt = function(t) {
      function e() {
          ...
          this.context = st.ctx,
          e.__super.call(this),
          this._onPlayEnd = K.bind(this.__onPlayEnd, this),
      ...
      n.stop = function() {
          ...
          E.removeChannel(this),
          this.completeHandler = null,
          E.autoReleaseSound && i.timer.once(5e3, null, E.disposeSoundIfNotUsed, [this.url], !1)
      }
      ,
      n.pause = function() {
    ...
    , pt = function(t) {
      function e() {
          ...
          e.__super.call(this),
          this._interval = a.animationInterval,
    ...
    , gt = function(t) {
      ...
      ,
      o.lang = function(t, i, n, s, r, o, a, h, l, u, c) {
      ...
      o._isPassWordMode = function() {
          var t = this._style
            , e = t.password;
          return "prompt"in this && this.prompt == this._text && (e = !1),
          e
      }
      ,
      ...
      o.renderText = function(t, e) {
          ...
          r = this._width - s[1]) : "center" == this.align && (o = "center",
          r = .5 * this._width + s[3] - s[1])),
          this._height > 0) {
          ...
          for (var m = 0, v = 0, y = Math.min(this._lines.length, e + t) || 1, w = t; w < y; w++) {
              ...
              v = u + h * w - (this._clipPoint ? this._clipPoint.y : 0),
              this.underline && this.drawUnderline(o, m, v, w),
              l) {
                  var M = this.width;
                  ...
                  x = this._words.length > w - t ? this._words[w - t] : new J,
                  x.setText(T)) : x = T,
      ...
      o.typeset = function() {
          ...
          N.context.font = this._getCSSStyle().font,
          this._lines.length = 0,
          this._lineWidths.length = 0,
          this._isPassWordMode() ? this.parseLines(this._getPassWordTxt(this._text)) : this.parseLines(this._text),
          this.evalTextSize(),
          this.checkEnabledViewportOrNot() ? this._clipPoint || (this._clipPoint = new S(0,0)) : this._clipPoint = null;
      ...
      o.parseLines = function(t) {
          ...
          for (var r = t.replace(/\r\n/g, "\n").split("\n"), o = 0, a = r.length; o < a; o++) {
              var h = r[o];
              i ? this.parseLine(h, n) : (this._lineWidths.push(this.getTextWidth(h)),
              this._lines.push(h))
          }
      }
      ,
      o.parseLine = function(t, i) {
          var n, s = (N.context,
          this._lines), r = 0, o = NaN, a = NaN, h = 0;
          if ((o = this.getTextWidth(t)) <= i)
              return s.push(t),
              void this._lineWidths.push(o);
          o = this._charSize.width,
          r = Math.floor(i / o),
          0 == r && (r = 1),
          o = this.getTextWidth(t.substring(0, r)),
          a = o;
          for (var l = r, u = t.length; l < u; l++)
              if (o = this.getTextWidth(t.charAt(l)),
              (a += o) > i)
                  if (this.wordWrap) {
                      ...
                      0 == n.index ? l += c.length : c = t.substring(h, l)),
                      s.push(c),
                      this._lineWidths.push(a - o),
                      h = l,
                      !(l + r < u)) {
                      ...
                      l += r,
                      o = this.getTextWidth(t.substring(h, l)),
                      a = o,
                      l--
                  } else if (this.overflow == e.HIDDEN)
                      return s.push(t.substring(0, l)),
                      void this._lineWidths.push(this.getTextWidth(s[s.length - 1]));
          this.wordWrap && -1 != h && (s.push(t.substring(h, u)),
          this._lineWidths.push(this.getTextWidth(s[s.length - 1])))
      }
      ,
      ...
      o.getWordWrapWidth = function() {
          ...
          e <= 0 && (e = this.wordWrap ? 100 : N.width),
          e <= 0 && (e = 100),
          e - t[3] - t[1]
      }
      ,
      o.getCharPoint = function(t, e) {
          ...
          return (e || new S).setTo(this._startX + u - (this._clipPoint ? this._clipPoint.x : 0), this._startY + h * (this._charSize.height + this.leading) - (this._clipPoint ? this._clipPoint.y : 0))
      }
      ,
      r(0, o, "width", function() {
          return this._width ? this._width : this.textWidth + this.padding[1] + this.padding[3]
      }, function(t) {
          t != this._width && (i.superSet(ct, this, "width", t),
          this.isChanged = !0)
      }),
      ...
      r(0, o, "height", function() {
          ...
          t != this._height && (i.superSet(ct, this, "height", t),
          this.isChanged = !0)
      }),
    ...
    , mt = function(t) {
      function e() {
          function t() {
              "hidden" == N.document[o] ? r._setStageVisible(!1) : r._setStageVisible(!0)
          }
          function i(t) {
          ...
          this._previousOrientation = N.window.orientation;
          var n = this;
          ...
          s.addEventListener("blur", function() {
              ...
              r.event("blur"),
              r.event("focuschange"),
              r._isInputting() && (xt.inputElement.target.focus = !1)
          });
          var o = "visibilityState"
            , a = "visibilitychange"
            , h = s.document;
          void 0 !== h.hidden ? (a = "visibilitychange",
          o = "visibilityState") : void 0 !== h.mozHidden ? (a = "mozvisibilitychange",
          o = "mozVisibilityState") : void 0 !== h.msHidden ? (a = "msvisibilitychange",
          o = "msVisibilityState") : void 0 !== h.webkitHidden && (a = "webkitvisibilitychange",
          o = "webkitVisibilityState"),
          s.document.addEventListener(a, t),
          s.document.addEventListener("qbrowserVisibilityChange", i),
          s.addEventListener("resize", function() {
              var t = N.window.orientation;
              null != t && t != n._previousOrientation && r._isInputting() && (xt.inputElement.target.focus = !1),
              n._previousOrientation = t,
              r._isInputting() || r._resetCanvas()
          }),
          s.addEventListener("orientationchange", function(t) {
              r._resetCanvas()
          }),
          this.on("mousemove", this, this._onmouseMove),
          N.onMobile && this.on("mousedown", this, this._onmouseMove)
      }
      ...
      a.render = function(e, n, s) {
          ...
          !this._style.visible)
              return void (this._renderCount % 5 == 0 && ($.loopCount++,
              v.instance.runEvent(),
              i.timer._update()));
          ...
          h || l || R.isConchApp) {
              ...
              if (R.isConchNode)
                  ...
                  _ = this._scenes.length; c < _; c++)
                      (u = this._scenes[c]) && u._updateSceneConch();
              else
                  for (c = 0,
                  _ = this._scenes.length; c < _; c++)
                      (u = this._scenes[c]) && u._updateScene();
              if (R.isConchNode) {
                  var d = ct.CustomList;
                  for (c = 0,
                  _ = d.length; c < _; c++) {
          ...
          R.isConchNode || !this.renderingEnabled || !h && l || (R.isWebGL ? (e.clear(),
          t.prototype.render.call(this, e, n, s),
          $._show && $._sp && $._sp.render(e, n, s),
          o.clear(this._bgColor),
          o.beginFlush(),
          e.flush(),
          o.endFinish(),
          q.instance && q.getInstance().endDispose()) : (o.clear(this._bgColor),
          t.prototype.render.call(this, e, n, s),
          $._show && $._sp && $._sp.render(e, n, s)))
      }
      ,
      ...
      r(0, a, "bgColor", function() {
          ...
          R.isWebGL && (t ? e._wgColor = U.create(t)._color : N.onMiniGame || (e._wgColor = null)),
          N.onLimixiu ? e._wgColor = U.create(t)._color : R.canvas.style.background = t || "none"
      }),
  ...
  function(t) {
    ...
    , yt = function(t) {
      function e(t, i) {
          ...
          "2D" === t || "AUTO" === t && !R.isWebGL) {
              this._is2D = !0,
              this._source = i || N.createElement("canvas"),
              ...
              s.getContext = function(t, e) {
                  ...
                  return i && (i._canvas = s,
                  R.isFlash || N.onLimixiu || (i.size = function(t, e) {}
                  )),
                  i
              }
          }
    ...
    , wt = (function(t) {
      ...
      s(e, "laya.resource.HTMLSubImage", t),
      e.create = function(t, i, n, s, r, o, a, h) {
          return void 0 === h && (h = !1),
          new e(t,i,n,s,r,o,a,h)
      }
  }(ft),
  function(t) {
      function e() {
      ...
      n._setFramesFromCache = function(t, i) {
          ...
          t && e.framesMap[t]) {
              ...
              n instanceof Array ? (this._frames = e.framesMap[t],
      ...
      n.loadAtlas = function(t, n, s) {
          function r(i) {
              t === i && (o.frames = e.framesMap[s] ? e.framesMap[s] : e.createFrames(t, s),
              n && n.run())
          }
          void 0 === s && (s = ""),
          this._url = "";
      ...
      n.loadAnimation = function(t, e, n) {
          ...
          s._setFramesFromCache("") ? (s._setFramesFromCache(this._actionName, !0),
          this.index = 0,
          e && e.run()) : !n || ot.getAtlas(n) ? this._loadAnimationData(t, e, n) : i.loader.load(n, l.create(this, this._loadAnimationData, [t, e, n]), null, "atlas"),
          this
      }
      ,
      n._loadAnimationData = function(t, n, s) {
          function r(i) {
              if (ot.getRes(i) && t === i) {
                  var s;
                  if (e.framesMap[t + "#"])
                      a._setFramesFromCache(o._actionName, !0),
                      o.index = 0,
          ...
          var o = this;
          if (s && !ot.getAtlas(s))
              return void console.warn("atlas load fail:" + s);
          var a = this;
      ...
      e.createFrames = function(t, i) {
          ...
          if ("string" == typeof t) {
              ...
              if (h && h.length)
                  ...
                  r = 0,
                  a = h.length; r < a; r++)
                      s = new o.createGraphics,
                      s.drawTexture(ot.getRes(h[r]), 0, 0),
                      n.push(s)
  ...
  function(t) {
      ...
      i._calculateFrameValues = function(t, e, i) {
          ...
          if (o > this._count && (this._count = o),
          t.tween)
              for (n = Y[t.tweenMethod],
              null == n && (n = Y.linearNone),
              s = r; s < o; s++)
                  i[s] = n(s - r, a, h, l),
    ...
    , xt = function(t) {
      ...
      o._syncInputTransform = function() {
          ...
          R.isConchApp ? (t.setScale(n.scaleX, n.scaleY),
          t.setSize(s, r),
      ...
      o._focusIn = function() {
          ...
          !R.isConchApp && N.onPC && i.timer.frameLoop(1, this, this._syncInputTransform)
      }
      ,
      o._setPromptColor = function() {
          e.promptStyleDOM = N.getElementById("promptStyle"),
          e.promptStyleDOM || (e.promptStyleDOM = N.createElement("style"),
          e.promptStyleDOM.setAttribute("id", "promptStyle"),
          N.document.head.appendChild(e.promptStyleDOM)),
      ...
      o._onKeyDown = function(t) {
          13 === t.keyCode && (N.onMobile && !this._multiline && (this.focus = !1),
          this.event("enter"))
      }
      ,
      ...
      r(0, o, "focus", function() {
          ...
          i.blur(),
          R.isConchApp ? i.setPos(-1e4, -1e4) : e.inputContainer.contains(i) && e.inputContainer.removeChild(i)))
      }),
      ...
      r(0, o, "editable", function() {
          ...
          this._editable = t,
          R.isConchApp && e.input.setForbidEdit(!t)
      }),
      ...
      e.__init__ = function() {
          ...
          N.onMobile && R.canvas.addEventListener(e.IOS_IFRAME ? N.onMiniGame ? "touchend" : "click" : "touchend", e._popupInputMethod)
      }
      ,
      ...
      e._createInputElement = function() {
          e._initInput(e.area = N.createElement("textarea")),
          e._initInput(e.input = N.createElement("input")),
          e.inputContainer = N.createElement("div"),
          e.inputContainer.style.position = "absolute",
          e.inputContainer.style.zIndex = 1e5,
          N.container.appendChild(e.inputContainer),
    ...
    , Tt = function(t) {
      ...
      return i._init_ = function(t, e) {
          this._src = t,
          this._source = new N.window.Image,
    ...
    , bt = (function(t) {
      ...
      i._displayNodeToFrame = function(t, e, i) {
          if (this._target) {
              var n;
              n = this._target;
              var s, r, o, a, h = t.frames, l = t.keys, u = 0, c = l.length;
              a = t.secondFrames;
              var _, d, f, p, g = 0;
              for (u = 0; u < c; u++)
                  s = l[u],
                  r = h[s],
                  g = a[s],
                  -1 == g ? o = this._initData[s] : e < g ? (d = t.keyframes[s],
                  f = d[0],
                  f.tween ? (_ = Y[f.tweenMethod],
                  null == _ && (_ = Y.linearNone),
                  p = d[1],
                  o = _(e, this._initData[s], p.value - this._initData[s], p.index)) : o = this._initData[s]) : o = r.length > e ? r[e] : r[r.length - 1],
                  n[s] = o
          }
      }
      ,
  ...
  function(t) {
      ...
      r._createGraphicData = function() {
          ...
          var s;
          for (e = 0; e < i; e++)
              !n[e] && s || (s = this._createFrameGraphic(e)),
              t.push(s);
          this._gList = t
      }
      ,
      r._createFrameGraphic = function(t) {
          ...
          return e._rootMatrix || (e._rootMatrix = new M),
      ...
      r._updateNodeGraphic = function(t, e, i, n, s) {
          ...
          if (!(o < .01)) {
              ...
              if (l = t.child) {
                  ...
                  for (c = l.length,
                  u = 0; u < c; u++)
                      this._updateNodeGraphic(l[u], e, a, n, o)
              }
          }
      }
      ,
      ...
      r._updateNodeGraphic2 = function(t, e, i) {
          ...
          !t.child)
              return void this._updateNoChilds(n, i);
          var s = n.transform;
          s._checkTransform();
          var r = !1;
          r = !s.bTransform;
      ...
      r._getParams = function(t, i, n, s) {
          ...
          var o = 0
            , a = i.length;
          for (o = 0; o < a; o++)
              r[o] = this._getObjVar(t, i[o][0], n, i[o][1], s);
          return r
      }
      ,
      ...
      r._getNodeGraphicData = function(t, n, s) {
          s || (s = i.create()),
          s.transform ? s.transform.identity() : s.transform = M.create();
      ...
      e.__init$ = function() {
          i = function() {
              ...
              t.prototype.recover = function() {
                  ...
                  this.resultTransform = null),
                  X.recover("GraphicNode", this)
              }
              ,
              t.create = function() {
                  return X.getItemByClass("GraphicNode", t)
              }
              ,
              t
          }()
